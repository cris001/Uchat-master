...
public class SettingsActivity extends UI implements SettingsAdapter.SwitchChangeListener {
    ...
    private static final int TAG_PERMISSION=66;//权限认证
...
//        items.add(SettingTemplate.makeSeperator());
        ...
        items.add(new SettingTemplate(TAG_PERMISSION,getString(R.string.permission_verify)));
        items.add(SettingTemplate.addLine());
    ...
    private void onListItemClick(SettingTemplate item) {
        ...
        switch (item.getId()) {
            ...
            case TAG_JS_BRIDGE:
                ...
                break;
            case TAG_PERMISSION:
                startActivity(new Intent(SettingsActivity.this,LimitSettingActivity.class));
            default:
                break;
        }
    }
