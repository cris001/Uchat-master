...
import com.netease.nim.demo.session.action.FileDownloadAction;
import com.netease.nim.demo.session.action.FileUploadAction;
...
//            p2pCustomization.backgroundUri = "android.resource://com.netease.nim.demo/drawable/bk"
            ...
            // actions.add(new SnapChatAction());
            // actions.add(new GuessAction());
            actions.add(new FileUploadAction());
            actions.add(new FileDownloadAction());

//            actions.remove(new ImageAction());
//            actions.remove(new VideoAction());
//            actions.remove(new LocationAction());
//            actions.add(new FileAction());
            ...
            SessionCustomization.OptionsButton infoButton = new SessionCustomization.OptionsButton() {
                @Override
                public void onClick(Context context, View view, String sessionId) {
                    MessageInfoActivity.startActivity(context, sessionId); //打开界面
                }
            };
